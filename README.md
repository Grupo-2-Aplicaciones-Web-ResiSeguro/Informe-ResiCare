...
| 0.8     | 09/09/2025 | José Pariona                                             |  Subidas:  Capítulo IV: Product Desig  4.1. Style Guidelines, 4.1.1. General Style Guidelines, 4.1.2. Web Style Guidelines, 4.2. Information Architecture, Organization Systems, Labeling Systems, SEO Tags and Meta Tags, Searching Systems, Navigation Systems, 4.3. Landing Page UI Design, Wireframe, Mock-up Partes de Capítulo IV y V, Despliegue y creacion de la primera versión del Landing Page                                                                                                                                                                    |
...
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | **Jose Manuel Pariona Lucas**<br> **TB1**<br>- Capítulo IV: Product Design<br>   - 4.1. Style Guidelines <br>   - 4.1.1. General Style Guidelines<br>   - 4.1.2. Web Style Guidelines<br>   - 4.2. Information Architecture<br>       - Organization Systems<br>       - Labeling Systems<br>       - SEO Tags and Meta Tags<br>       - Searching Systems<br>       - Navigation Systems<br>   - 4.3. Landing Page UI Design<br>       - Wireframe<br>       - Mock-up<br>- Partes de Capítulo IV y V<br>- Despliegue de la primera versión del Landing Page<br> **Vanessa May Lang Choy Robles**<br> **TB1**<br> Lo avances fueron realizadas en coordinación con mis compañeros, generando un entorno de colaboración y asegurando todos los entregable. La construcción de los mapas de usuario y del backlog fortaleció el trabajo colaborativo, ya que cada integrante pudo aportar desde su perspectiva. Se establecieron metas claras y se cumplió con la entrega de los avances en tiempo y forma. Además, se garantizó que el sistema diseñado respondiera de manera efectiva a las necesidades identificadas de los usuarios y los problemas actuales del sistema luego de haber organizando y priorizando las historias de usuario en función de los objetivos estratégicos del proyecto.<br><br>**Carlo Patricio Ramirez Escalante**<br> **TB1**<br>El trabajo se desarrolló en un entorno colaborativo en el que la coordinación con el equipo permitió cumplir los objetivos planteados. A partir de las metas establecidas, elaboré el diagrama de clases, lo que facilitó la representación de los componentes del sistema y su coherencia con las historias de usuario. Asimismo, diseñé el diagrama de base de datos, asegurando que la estructura relacional respondiera a las necesidades del proyecto y brindara soporte a las funcionalidades definidas en el backlog. Estos aportes contribuyeron a la organización de las tareas y a la consolidación de un resultado alineado con los objetivos estratégicos del grupo.<br> **Hector Javier Ríos Pacheco TB1:** Durante esta primera entrega hubo un desarrollo en conjunto de manera organizada, permitiendo el avance satisfactorio de todos lo puntos en esta entrega. Realicé el capítulo 1, secciones dle capítulo 2, wireframes y mockups, además de colaborar en otros aspectos.<br> **Jude Alessandro Hermoza Quispe TB1:** Contribuí a un entorno colaborativo mediante el ReWork de la Landing Page, integrando mejoras en usabilidad y diseño. Además, participé en la documentación de servicios, construcción de user personas, definición de lenguaje ubicuo, matriz de tareas de usuario, supuestos Lean UX y problem statements. Estas actividades facilitaron la organización del backlog, la priorización de tareas y aseguraron que el sistema diseñado respondiera a los objetivos del proyecto.| TB1: Durante el desarrollo, se fomentó un ambiente participativo en el que cada miembro pudo aportar libremente sus ideas. Se definieron metas claras y se distribuyeron las actividades de forma organizada, lo que facilitó la planificación y el cumplimiento de los objetivos establecidos en el plazo acordado. |
...
|  | **ResiCare**<br><img src="./assets/competidores/resicare.png" alt="ResiCare" width="200"> | **Insurama**<br><img src="./assets/competidores/insurama.jpg" alt="Insurama" width="180"> | **Rimac**<br><img src="./assets/competidores/rimac.png" alt="Rimac" width="200"> | **Pacífico**<br><img src="./assets/competidores/pacifico.jpg" alt="Pacifico" width="200"> |
|---------------------------------------------------------------|-----------------------------|---------------------------|---------------------------|---------------------------|
...
https://www.figma.com/design/MbSWxpISHCu4lR16zetn4j/Untitled?node-id=0-1&t=kNHBqwGygzE2m0bN-1
...
1. Accedemos a la plataforma para iniciar sesión: https://www.figma.com/login
   <br>
