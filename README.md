...
|---------------------|---------------------|--------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | **Jose Manuel Pariona Lucas**<br> **TB1**<br>- Capítulo IV: Product Design<br>   - 4.1. Style Guidelines <br>   - 4.1.1. General Style Guidelines<br>   - 4.1.2. Web Style Guidelines<br>   - 4.2. Information Architecture<br>       - Organization Systems<br>       - Labeling Systems<br>       - SEO Tags and Meta Tags<br>       - Searching Systems<br>       - Navigation Systems<br>   - 4.3. Landing Page UI Design<br>       - Wireframe<br>       - Mock-up<br>- Partes de Capítulo IV y V<br>- Despliegue de la primera versión del Landing Page<br>  **Vanessa May Lang Choy Robles**<br> **TB1**<br> - 4.6. Domain-Driven Software Architecture<br> - 4.6.1. Software Architecture Context Diagrams<br> - 4.6.2. Software Architecture Container Diagrams<br> - 4.6.3. Software Architecture Components Diagrams<br> - 2.3.3. User Journey Mapping<br> - 2.3.4. Empathy Mapping<br> - 2.3.5. As-is Scenario Mapping
